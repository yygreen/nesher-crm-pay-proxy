...
// filter, never the only one. Only GET /health /balances /transactions /caps /state are
...
export const MONEY_HOP_FORWARDABLE = ["/health", "/balances", "/transactions", "/caps", "/state"];
export const MONEY_HOP_BUILD = "2026-09-23-money-hop";
