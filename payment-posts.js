...
export const REVIEW_WORDS = Object.freeze({
  ...
  mercury_same_amount_on_booking: "A Mercury pay-link payment came in for the same amount as a payment already on the booking. If it is the same money, nothing to enter; if it is a second payment, enter it.",
